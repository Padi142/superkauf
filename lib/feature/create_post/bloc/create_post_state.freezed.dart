...
abstract class Loading implements CreatePostState {
...
class _$ImagePickedImpl implements ImagePicked {
  ...
  @override
  String toString() {
    return 'CreatePostState.imagePicked(image: $image)';
  }
...
abstract class ImagePicked implements CreatePostState {
...
class _$ImageUploadedImpl implements ImageUploaded {
  const _$ImageUploadedImpl(this.image);
  ...
  @override
  String toString() {
    return 'CreatePostState.imageUploaded(image: $image)';
  }
...
abstract class ImageUploaded implements CreatePostState {
  const factory ImageUploaded(final String image) = _$ImageUploadedImpl;
...
abstract class Error implements CreatePostState {

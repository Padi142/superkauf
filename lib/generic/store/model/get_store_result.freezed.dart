...
/// @nodoc
abstract class $GetStoreResultCopyWith<$Res> {
  factory $GetStoreResultCopyWith(GetStoreResult value, $Res Function(GetStoreResult) then) = _$GetStoreResultCopyWithImpl<$Res, GetStoreResult>;
}

/// @nodoc
class _$GetStoreResultCopyWithImpl<$Res, $Val extends GetStoreResult> implements $GetStoreResultCopyWith<$Res> {
  _$GetStoreResultCopyWithImpl(this._value, this._then);
...
/// @nodoc
class __$$SuccessImplCopyWithImpl<$Res> extends _$GetStoreResultCopyWithImpl<$Res, _$SuccessImpl> implements _$$SuccessImplCopyWith<$Res> {
...
class _$SuccessImpl implements Success {
  const _$SuccessImpl(this.store);
  ...
  @override
  String toString() {
    return 'GetStoreResult.success(store: $store)';
  }

  @override
  bool operator ==(Object other) {
    return identical(this, other) || (other.runtimeType == runtimeType && other is _$SuccessImpl && (identical(other.store, store) || other.store == store));
  }
...
abstract class Success implements GetStoreResult {
  const factory Success(final StoreModel store) = _$SuccessImpl;
...
/// @nodoc
class __$$FailureImplCopyWithImpl<$Res> extends _$GetStoreResultCopyWithImpl<$Res, _$FailureImpl> implements _$$FailureImplCopyWith<$Res> {
...
class _$FailureImpl implements Failure {
  ...
  @override
  String toString() {
    return 'GetStoreResult.failure(message: $message)';
  }
...
abstract class Failure implements GetStoreResult {

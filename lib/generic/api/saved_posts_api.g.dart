...
class _SavedPostsApi implements SavedPostsApi {
  ...
  Future<List<FeedPostModel>> getUserSavedPosts({required int id}) async {
    ...
    final _result = await _dio
        .fetch<List<dynamic>>(_setStreamType<List<FeedPostModel>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    var value = _result.data!
        .map((dynamic i) => FeedPostModel.fromJson(i as Map<String, dynamic>))
        .toList();
    return value;
  }
  ...
  Future<SavedPostModel> createSavedPost(
    ...
    _data.addAll(body);
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<SavedPostModel>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )

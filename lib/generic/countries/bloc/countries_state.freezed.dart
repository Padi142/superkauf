...
abstract class $CountriesStateCopyWith<$Res> {
  factory $CountriesStateCopyWith(CountriesState value, $Res Function(CountriesState) then) = _$CountriesStateCopyWithImpl<$Res, CountriesState>;
}

/// @nodoc
class _$CountriesStateCopyWithImpl<$Res, $Val extends CountriesState> implements $CountriesStateCopyWith<$Res> {
...
/// @nodoc
class __$$LoadingImplCopyWithImpl<$Res> extends _$CountriesStateCopyWithImpl<$Res, _$LoadingImpl> implements _$$LoadingImplCopyWith<$Res> {
...
abstract class Loading implements CountriesState {
...
/// @nodoc
class __$$LoadedImplCopyWithImpl<$Res> extends _$CountriesStateCopyWithImpl<$Res, _$LoadedImpl> implements _$$LoadedImplCopyWith<$Res> {
...
class _$LoadedImpl implements Loaded {
  const _$LoadedImpl(final List<CountryModel> countries) : _countries = countries;
  ...
  @override
  bool operator ==(Object other) {
    return identical(this, other) || (other.runtimeType == runtimeType && other is _$LoadedImpl && const DeepCollectionEquality().equals(other._countries, _countries));
  }
...
abstract class Loaded implements CountriesState {
  const factory Loaded(final List<CountryModel> countries) = _$LoadedImpl;
...
/// @nodoc
class __$$ErrorImplCopyWithImpl<$Res> extends _$CountriesStateCopyWithImpl<$Res, _$ErrorImpl> implements _$$ErrorImplCopyWith<$Res> {
...
abstract class Error implements CountriesState {
